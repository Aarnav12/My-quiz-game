class Question {
  ...
  display() {
    ...
    this.question.html(
      "Question:- What is the depth of 'THE CHALLENGER DEEP' below the see level? "
    );
    this.question.position(150, 80);
    this.option1.html("1: 1094 ");
    this.option1.position(150, 100);
    this.option2.html("2: 10235");
    this.option2.position(150, 120);
    this.option3.html("3: 3259 ");
    this.option3.position(150, 140);
    this.option4.html("4: 15706");
